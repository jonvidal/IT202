...
<div class="container" id="Content">
  <div class="container" style="float:right;font-size:12px;padding-right:50px;padding-top:50px;color:red;font-weight:bolder;"><?php echo $result; ?></div>
  <p class='in-p'>myTeam</p>
  <div class="container" class="in-content"><?php echo $response;?></div>
</div>
</body>
</html>